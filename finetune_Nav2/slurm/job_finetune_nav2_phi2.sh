#!/bin/bash
#SBATCH --job-name=nav2_ft_phi2
#SBATCH --output=nav2_finetune_phi2_%j.out
#SBATCH --error=nav2_finetune_phi2_%j.err
...
OUT_DIR="${OUT_DIR:-$WORK_DIR/finetune_Nav2/outputs/nav2_steps_phi2_lora_${SLURM_JOB_ID:-local}}"
