#!/bin/bash
#SBATCH --job-name=nav2_xml_ft_phi2
#SBATCH --output=nav2_xml_finetune_phi2_%j.out
#SBATCH --error=nav2_xml_finetune_phi2_%j.err
...
OUT_DIR="${OUT_DIR:-$WORK_DIR/finetune_Nav2_XML/outputs/nav2_xml_phi2_lora_${SLURM_JOB_ID:-local}}"
