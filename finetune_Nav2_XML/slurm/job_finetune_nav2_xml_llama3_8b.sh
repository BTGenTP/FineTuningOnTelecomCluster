#!/bin/bash
#SBATCH --job-name=nav2_xml_ft_llama3_8b
#SBATCH --output=nav2_xml_finetune_llama3_8b_%j.out
#SBATCH --error=nav2_xml_finetune_llama3_8b_%j.err
...
OUT_DIR="${OUT_DIR:-$WORK_DIR/finetune_Nav2_XML/outputs/nav2_xml_llama3_8b_lora_${SLURM_JOB_ID:-local}}"
