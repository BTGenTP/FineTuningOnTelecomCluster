...
## Catalogue coverage: 96.4%

- Skills used (in catalog): 27
- Skills NOT in catalog (potential contamination): 3
  - ChangeSimulationStatus, FinalizeAndPublishGraphicalPathDescription, PassGraphicalPreliminaryPathDescription
