% ============================================================================
% NAV4RAIL — Décisions d'architecture
...
\hypersetup{
    ...
    citecolor=NavyBlue,
    urlcolor=NavyBlue,
    pdftitle={NAV4RAIL -- Décisions d'architecture},
    pdfauthor={Équipe NAV4RAIL},
}
...
\vspace{2cm}
{\large Équipe NAV4RAIL --- SNCF\par}
\vspace{1cm}
{\large\today\par}
\vfill
...
Le projet \textbf{NAV4RAIL} vise à permettre à un opérateur de décrire une
...
compatible avec la bibliothèque \textbf{BehaviorTree.CPP v4}. Ces BT
commandent un robot de maintenance sur le réseau ferré de la SNCF.
...
\begin{description}[leftmargin=3.5cm, style=nextline]
    ...
    BT. Le format v4 est le standard XML utilisé dans NAV4RAIL.
...
ont été remplacés par les 27~skills réels du système NAV4RAIL (ex.~:
